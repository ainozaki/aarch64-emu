...
private:
  void write_8(void *addr, uint8_t value);
  void write_16(void *addr, uint16_t value);
  void write_32(void *addr, uint32_t value);
  void write_64(void *addr, uint64_t value);
