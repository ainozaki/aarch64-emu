...
void Cpu::decode_ldst_reg_immediate(uint32_t inst)
{
  ...
  else
  {
    ...
    case 0b11:
      ...
      {
      case 0:
        xregs[rt] = util::set_lower32(xregs[rt], util::SIGN_EXTEND(bus.load8(address), 8));
        break;
      case 1:
        xregs[rt] = util::set_lower32(xregs[rt], util::SIGN_EXTEND(bus.load16(address), 16));
        break;
      case 2:
      case 3:
        unallocated();
